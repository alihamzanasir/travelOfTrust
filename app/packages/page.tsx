...
export default function PackagesPage() {
  ...
  const packages = [
    ...
    {
      id: 3,
      title: "Economical Umrah Package",
      category: "umrah",
      duration: "7 Days",
      price: "$999",
      rating: 4.5,
    ...
    <main>
      ...
      <section className="relative h-[400px] w-full">
        ...
        <div className="absolute">
          <div className="container mx-auto px-4 h-full flex flex-col justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-4 mt-10">Our Umrah Packages</h1>
              <p className="text-lg mb-6">Carefully designed packages for a meaningful pilgrimage</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Explore Our Packages</h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              We offer a variety of packages to suit different needs and preferences. Browse our selection to find the
              perfect package for your spiritual journey.
            </p>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex text-yellow-400 mb-2">
                    ...
                    <span className="text-gray-600 text-sm ml-2">{pkg.rating}/5</span>
                  </div>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-6">
                    ...
                    package tailored specifically to your requirements.
                  </p>
                  <ul className="mb-6 space-y-2">
              ...
              <div className="relative h-full min-h-[300px]">
                <Image src="/images/umrah-packages-pakistan-edited.webp" alt="Custom Package" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl font-bold mb-6">Ready to Book Your Umrah Journey?</h2>
              <p className="text-lg mb-8 opacity-90">
                Contact us today to book your package or to learn more about our services.
              </p>
